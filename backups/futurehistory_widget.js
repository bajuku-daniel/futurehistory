        ...
        $("#futurehistory-map-" + i).once('futurehistory-googlemaps', function(){
          ...
          $("#futurehistory-arview-" + i + " input").click(function(){ 
            if ($(this).is(':checked')){
              ...
              Drupal.futurehistory.angle_sliders[i].slider("option", "value", angle);
              ...
              Drupal.futurehistory.direction_sliders[i].slider("option", "disabled", true);
              ...
              Drupal.futurehistory.direction_sliders[i].slider("option", "disabled", false);
          ...
          Drupal.futurehistory.direction_sliders[i] = $("#futurehistory-view_direction-slider-" + i + " ").slider({
            value: direction,
            min: 1,
            max: 360,
            step: 1,
          ...
          Drupal.futurehistory.angle_sliders[i] = $("#futurehistory-angle-slider-" + i + " ").slider({
            ...
            animate: true,
            slide : function( event, ui ) {
              $('#futurehistory-angle-slider-item-' + i + ' span').html(ui.value);
              ...
              Drupal.futurehistory.setMapArrow(latLng, i, dist, direction, ui.value);
              angle = ui.value;
            }
          });
