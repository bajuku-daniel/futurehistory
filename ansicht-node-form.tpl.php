...
<?php
  ...
  foreach( $form['ansicht_tabs'] as $tab => $tab_content ) {
    ...
    } else if ($tab == 'group_add_picture' && $validation_error == 0){
...
<input type="hidden" id="ansicht_initial" value="<?php print($ansicht_initial['initial']); ?>" >
...
<?php
  ...
  foreach( $form['ansicht_tabs'] as $tab => $tab_content ) {
    ...
    if ($ansicht_button_static == 0 &&  $validation_error == 1 && $tab_content['validation_error'] == 1 ) {
    ...
    } else if ($ansicht_button_static == 0 && $tab == 'group_add_picture' && $validation_error == 0){
      $tab_pane = '<div class="tab-pane active" id="' . $tab . '">';   
      $form_buttons = '
        <div class="addAnsichtButtons">    
          <a class="btn btn-primary btnNext">weiter</a>
      ...
      ';
    } else if ($ansicht_button_static == 0) {
      $tab_pane = '<div class="tab-pane" id="' . $tab . '">';
      if ($tab == 'group_media') {
        $form_buttons = '
          <div class="addAnsichtButtons">    
